  ...
  implements View.OnClickListener
{
  ...
  private void write(String paramString)
  {
    try
    {
      ...
      localStringBuffer.append("\n");
      paramString = new java/io/FileWriter;
      paramString.<init>(this.soundFileLog, true);
      paramString.append(localStringBuffer);
      paramString.close();
      return;
    }
...
/* Location:              C:\Root\@Objects\Tablet\Resmed\App Inspect\JD Gui\com.resmed.refresh-158.jar!\com\resmed\refresh\SoundRecordingActivty.class
