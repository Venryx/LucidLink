  ...
  implements RefreshBluetoothManager, EdfLibCallbackHandler
{
  ...
  public void handleNewPacket(ByteBuffer paramByteBuffer)
  {
    ...
    paramByteBuffer = new String(localVLPacket.buffer);
    Log.d("com.resmed.refresh.bluetooth", "BluetoothMock::handleNewPacket() processed new bluetooth data : " + paramByteBuffer + "packet type : " + localVLPacket.packetType + " size : " + localVLPacket.buffer.length);
...
/* Location:              C:\Root\@Objects\Tablet\Resmed\App Inspect\JD Gui\com.resmed.refresh-158.jar!\com\resmed\refresh\bluetooth\BluetoothManagerMock.class
