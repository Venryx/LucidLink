...
class HasteMap extends EventEmitter {
  ...
  build() {
    ...
    const promises = [];
	 ...
	 // custom
	 /*this._files = this._files.map(a=>a.replace(/\\/g, "/"));
	 for (let [index, file] of this._files.entries()) {
		 let lastIndex;
		while ((lastIndex = this._files.lastIndexOf(file)) != index) {
			this._files.splice(lastIndex, 1);
		}
	 }*/
