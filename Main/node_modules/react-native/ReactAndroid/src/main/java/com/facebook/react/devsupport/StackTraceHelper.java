...
public class StackTraceHelper {
  ...
  public static StackFrame[] convertJsStackTrace(@Nullable ReadableArray stack) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      String fileName = frame.hasKey("file") && !frame.isNull("file") ? frame.getString("file") : "unknown";
      //int lineNumber = frame.getInt("lineNumber");
	  int lineNumber = frame.hasKey("lineNumber") && !frame.isNull("lineNumber") ? frame.getInt("lineNumber") : -1;
      int columnNumber = -1;
