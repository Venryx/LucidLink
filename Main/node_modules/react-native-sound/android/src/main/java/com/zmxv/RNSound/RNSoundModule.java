	...
	protected MediaPlayer createMediaPlayer(final String fileName) {
		...
		/*if (fileName.startsWith("file:///android_asset/")) {
			try {
				...
				AssetFileDescriptor assetFileInfo = context.getAssets().openFd(fileName.substring("file:///android_asset/".length()));
		...
		/*if (fileName.startsWith("//android_asset/"))
			//return MediaPlayer.create(this.context, Uri.fromFile(new File(fileName)));
			return MediaPlayer.create(this.context, Uri.parse(fileName));*/
	...
	public void play(final Integer key, final Callback callback) {
		...
		player.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mp) {
				if (!mp.isLooping()) {
					// custom replaced (lazy fix for crash, from callback being called more than once)
