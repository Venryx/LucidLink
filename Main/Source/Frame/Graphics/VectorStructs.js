...
g.VRect = class VRect {
	...
	NewX(valOrFunc) {
		return this.Clone().Init({x: valOrFunc instanceof Function ? valOrFunc(this.x) : valOrFunc});
	}
	NewLeft(valOrFunc) {
		return this.Clone().Init({Left: valOrFunc instanceof Function ? valOrFunc(this.Left) : valOrFunc});
	}
	NewRight(valOrFunc) {
		return this.Clone().Init({Right: valOrFunc instanceof Function ? valOrFunc(this.Right) : valOrFunc});
	}
	NewY(valOrFunc) {
	    return this.Clone().Init({y: valOrFunc instanceof Function ? valOrFunc(this.y) : valOrFunc});
	}
	NewBottom(valOrFunc) {
	    return this.Clone().Init({Bottom: valOrFunc instanceof Function ? valOrFunc(this.Bottom) : valOrFunc});
	}
	NewTop(valOrFunc) {
	    return this.Clone().Init({Top: valOrFunc instanceof Function ? valOrFunc(this.Top) : valOrFunc});
	}
	NewWidth(valOrFunc) {
	    return this.Clone().Init({width: valOrFunc instanceof Function ? valOrFunc(this.width) : valOrFunc});
	}
	NewHeight(valOrFunc) {
	    return this.Clone().Init({height: valOrFunc instanceof Function ? valOrFunc(this.height) : valOrFunc});
	}
