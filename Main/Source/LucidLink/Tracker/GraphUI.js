...
class ChartUI extends BaseComponent {
	...
	render() {
        ...
        return (
            <View style={{width, height, backgroundColor: colors.background}} onLayout={this.OnLayout}>
...
Our fixed rect: ${rect}`);*/
		...
		return (
			<Text style={{position: "absolute", left: rect.x, top: rect.y, height: rect.height}} onLayout={this.OnLayout}>
				{"|" + event.type}
			</Text>
		);
	}
